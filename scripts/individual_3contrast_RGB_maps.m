...
contrast_data = nan(fs_num, N_subjs, 3, 2); % vertices x subjs x contrasts x hemispheres
...
for ss = 1:N_subjs
    ...
    for hh = 1:2
        ...
        for cc = 1:3
            ...
            % Get tstat data
            stat_path = [contrast_path subjCode '/localizer/localizer_contrasts_' hemi '/' contrasts{cc} '/t.nii.gz'];
            ...
            for vv = 1:length(ptiles)-1
                ...
                contrast_data(mask,ss,cc,hh) = RGB_vals(vv);
            end            
        end
    end
end
...
for ss = 1:N_subjs
    ...
    for hh=1:2
        ...
        write_annotation([annot_outpath hemi '.'  subjCode '_VisAudWM_3contrast_RGB_' latmed '.annot'], verts_ref, annot_labels, annot_ctable);
