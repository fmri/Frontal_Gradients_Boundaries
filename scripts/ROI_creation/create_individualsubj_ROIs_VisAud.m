...
%     'VO', 'VOT'};
ROIs = {'visaud_sPCS_tgPCS_interface', 'visaud_tgPCS_iPCS_interface',...
...
contrasts = {'aAaPvAvP-f'};
N_contrasts = length(contrasts);
contrast_names = {'visaud'};
    ...
    for hh = 1:2
        ...
        for rr = 1:N_ROIs
            ...
            for cc = 1:N_contrasts
                ...
                data = MRIread([data_dir subjCode '/localizer/localizer_contrasts_0sm_' hemi '_audvis/' contrast '/sig.nii.gz']);
...
%% Check %s of ROIs
perc_ROIs = nan(N_ROIs, 2, N_contrasts);
for rr = 1:N_ROIs
    for hh = 1:2
        for cc = 1:N_contrasts
